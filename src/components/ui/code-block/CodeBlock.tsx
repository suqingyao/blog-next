...
import { useShiki } from '@/lib/shiki/client';
...
export function CodeBlock({
  ...
  // Use Shiki hook - returns HTML and background style with CSS variables
  const { html, bgStyle } = useShiki({
    code: currentCode,
      ...
      <div className="relative overflow-hidden">
        ...
        >
          <span className="relative size-3.5">
            ...
            >
              <div className="i-lucide-copy size-full"></div>
            </m.div>
            <m.div
              initial={false}
              animate={{
              ...
              className="absolute inset-0"
            >
              <div className="i-lucide-check size-full"></div>
            </m.div>
          </span>
        ...
        <pre
          ...
          style={bgStyle ? { cssText: bgStyle } as React.CSSProperties : undefined}
        >
