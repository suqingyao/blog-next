...
export function getBorderRadius(element: Element | null) {
  if (!element)
    return 0;
...
export function computeViewerImageFrame(photo: PhotoManifest, viewportRect: DOMRect | null, isMobile: boolean): AnimationFrameRect {
