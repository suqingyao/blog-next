---
  id: 20231118214713_common-css-centered-layout-methods
  title: CSS 常见居中布局方式
  createdTime: 2023-11-18 21:47:13
  published: true
---

<LinkCard
  title="CSS 水平居中布局方式"
  href="https://github.com/suqingyao/blog-demo/tree/main/packages/css-layout"
...
> [!WARNING] > `flex` 相对于 `grid` 的兼容性会更好，并且支持部分 ie 版本， 具体兼容请前往 [caniuse](https://caniuse.com/?search=grid) 查询
